<section class="relative isolate overflow-hidden">
    <div class="absolute inset-0 gradient"></div>
        <div class="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:py-28 lg:px-8">
            <h1 class="text-4xl font-extrabold tracking-tight sm:text-6xl">Find and join gaming servers on Gchat</h1>
            <p class="mt-4 max-w-2xl text-lg text-slate-600">Discover active communities for your favorite titles. Chat, squad up, and level up together.</p>
    ...
    <div class="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      <div class="bg-white w-full max-w-sm rounded-xl shadow-lg p-6 text-center space-y-3">
        ...
        <p class="text-sm text-gray-600">
          <?= $status === 'logged_out' ? 'You have been logged out.' : 'Your account has been deleted.' ?>
        </p>
